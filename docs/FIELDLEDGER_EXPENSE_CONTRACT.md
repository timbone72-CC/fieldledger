...
Blank amount values should be treated as zero while editing, but an expense should not be saved without a valid amount unless the user intentionally saves it as zero.
